...
//        ui->video0_topic_set_4->setText(topics[3]);
    ...
    QString master_url = settings.value("master_url",QString("http://192.168.2.120:11311/")).toString();
    QString host_url = settings.value("host_url", QString("192.168.2.20")).toString();
